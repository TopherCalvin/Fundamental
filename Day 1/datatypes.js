let str = '123';//string; karakter(huruf, angka, dan simbol) yang terletak diantara kutip (""), kutip satu (''),back tick (``)
let number = 123;//number; data berupa angka(desimal maupun bulat)
let bool = true;//boolean; data berupa true & false
let str2 = 'true';
let Null = null;//null; data yang sengaja tidak diisi ("", '', ``, null)
let Undefined; //undifined; data yang tidak diasign, hanya declare
...
let obj = {
 ...
 func: (n) => {
  console.log(n);
  return n;
 }//object; sebuah variable dengan properti dan method (function dalam sebuah variable) (keyed method)
};
...
let arr = [
 ...
 null,
 undefined
];// array; variable yang dapat menyimpan semua data, lebih dari satu
...
obj2.prop1 = '1234';//mengakses properti obj dengan "."
obj2.prop4 = '4444';//menambah properti obj baru sama dengan mengakses properti obj

const arr2 = [1, 2, 3, 4];
arr2[0] = 4;// merubah array menggunakan index
arr2[4] = 5;
arr2[50] = 5;
